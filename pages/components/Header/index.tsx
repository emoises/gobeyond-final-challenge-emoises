  ...
  return (
    <div className={styles.container}>
     ...
     <svg id="logo-corebiz-global" xmlns="http://www.w3.org/2000/svg" width="170" height="38.25" viewBox="0 0 216.126 48.66">
      ...
      <path id="Path_1" d="M421.544,446.507v7.727a17.9,17.9,0,0,0-2.5-.206c-5.763,0-8.608,2.82-8.608,9.077v16.98H402.8v-33.7h7.433v5.405a8.439,8.439,0,0,1,3.612-4.024,10.9,10.9,0,0,1,5.671-1.47A9.307,9.307,0,0,1,421.544,446.507Z" transform="translate(-334.5 -431.664)" fill="#fff"/>
      ...
      <path id="Path_4" d="M781.384,480.384H747.952v-6.638L769.075,453.3H747.6v-6.7h33.725v6.435l-21.387,20.623h21.446v6.727Z" transform="translate(-578.007 -431.883)" fill="#fff"/>
